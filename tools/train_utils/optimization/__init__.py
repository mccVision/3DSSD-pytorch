...
def build_scheduler(optimizer, total_iters_each_epoch, total_epochs, last_epoch, optim_cfg):
    ...
    elif optim_cfg.type == 'step':
        lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, total_steps, last_epoch=last_epoch)
    elif optim_cfg.type == 'cosine':
        lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLr(optimizer, total_steps, last_epoch=last_epoch)
    else:
        lr_scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lbmd, last_epoch=last_epoch)
